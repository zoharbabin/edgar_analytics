...
def test_analyze_quarterly_balance_sheets_partials(negative_cf):
    ...
    # a small DataFrame for balance_sheet & cash_flow_statement properties
    ...
    mock_mf.balance_sheet.return_value = bs_df
    mock_mf.cash_flow_statement.return_value = cf_df

    mock_MF = MagicMock()
    mock_MF.extract.return_value = mock_mf
    with patch("edgar_analytics.multi_period_analysis.MultiFinancials", mock_MF):
        mock_company = MagicMock()
